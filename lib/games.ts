...
export const GAMES: Game[] = [
  {
    ...
    shortName: 'LoL',
    description: 'MOBA by Riot Games, 5v5 competitive matches with champions and objectives.',
    genre: 'MOBA',
  ...
  },
  {
    slug: 'valorant',
    name: 'Valorant',
    description: 'Hero-based tactical shooter by Riot Games with unique agent abilities.',
  ...
  },
  {
    slug: 'apex-legends',
    name: 'Apex Legends',
    description: 'Hero-based battle royale with fast movement and team-focused gameplay.',
    genre: 'Battle Royale',
  ...
  },
  {
    ...
    description: 'Hardcore extraction shooter with realistic gunplay and complex economy.',
  ...
  },
  {
    slug: 'war-thunder',
    name: 'War Thunder',
    description: 'Combined arms military MMO with air, ground, and naval battles.',
  ...
  },
  {
    ...
    description: 'Tactical 5v5 shooter with destructible environments and operators.',
