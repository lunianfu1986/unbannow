...
export const metadata: Metadata = {
  ...
  description:
    'Honest reviews and case studies of ban appeal experiences, support responses, and policy changes across different games.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-8">
        Deep dives into how different publishers handle bans, appeals, and
