...
const PAGE_TYPE = 'Guide'

export const metadata: Metadata = {
  title: `Guides | ${siteConfig.name}`,
  description:
    'Step-by-step ban appeal guides, email templates, and account recovery tips for major online games.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-8">
        Practical tutorials that walk you through appealing bans, handling
        hacked accounts, and communicating with support teams.
      </p>
