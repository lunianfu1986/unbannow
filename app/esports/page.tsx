...
const PAGE_TYPE = 'Esports'

export const metadata: Metadata = {
  title: `Esports | ${siteConfig.name}`,
  description:
    'Esports-related ban news, competitive rulings, and high-profile suspension cases in the pro scene.',
}
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-8">
        Esports news focused on bans, competitive rulings, and account issues
        affecting pro players and tournaments.
      </p>

      {filteredPosts.length === 0 ? (
        <p className="text-gray-600 dark:text-gray-300">
          No esports articles yet. Check back soon!
        </p>
      ) : (
